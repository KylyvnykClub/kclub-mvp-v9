...
|Visual regression|The card, the catalogue, the partner page, the company application — in both themes and all three locales|Playwright screenshots against committed baselines|—|Included in the e2e run|
