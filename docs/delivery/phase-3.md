...
|T-3.5|14-day grace period on failed payment with Stripe dunning retries, access kept through the grace, subscriber notified on failure and before grace expiry|FR-056|T-3.1|1d|done 2026-08-12 — projection keeps vip during past_due, demotes on unpaid/canceled; invoice.payment_failed webhook writes notification outbox row; Resend email sender with payment-failed and grace-expiry templates in 3 locales; outbox-drain processes notification topic; 4 integration tests|
