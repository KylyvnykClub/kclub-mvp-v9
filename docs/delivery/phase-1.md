...
|T-1.9|Public card verification page (`/card/[token]`)|FR-022, FR-023, FR-024|T-1.1|0.5d|open|
|T-1.10|Staff revocation of cards|FR-025|T-1.1|0.5d|open|
|T-1.11|Security and constraints tests (Authz replay, Member leak walker)|FR-004|T-1.5, T-1.6|1d|open|
