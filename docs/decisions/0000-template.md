# NNNN. _(Short title, stated as the decision — "Use PostgreSQL for the primary datastore")_

> **Status:** Proposed
> **Date:** _(YYYY-MM-DD)_
> **Deciders:** _(who was in the room)_

## Context

> The situation that forced a decision. What problem appeared, what constrained
> the answer, what was true at the time. Write it so that someone in two years
...
> Why this option won. Be specific about what you optimised for — speed of
...
> The specific condition that would change this answer — a load threshold, a
